package com.example.todoSpringboot.interceptor;

import com.example.todoSpringboot.utils.CommonResult;
import com.example.todoSpringboot.utils.JwtTokenUtil;
...
//            将变量存在ThreadLocal
            ThreadLocalParaments.setStuId(username);
            System.out.println("拦截器响应！ID："+ThreadLocalParaments.getStuId());
            return true;
        }
        else{
            return false;
