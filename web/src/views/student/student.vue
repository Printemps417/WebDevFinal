<template>
    <div>
        ...
        <div class="side-bar">
            <el-menu class="el-menu-vertical-demo" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
                <el-menu-item index="/student/studenthome" @click="$router.push('/student/studenthome')" >
                    <i class="el-icon-house"></i>
                    <span slot="title">学生信息</span>
                </el-menu-item>
                <el-menu-item index="/rbac/user/list"  @click="$router.push('/student/selectlist')" >
                    <i class="el-icon-menu"></i>
                    <span slot="title">选课列表</span>
                </el-menu-item>
                <el-menu-item index="/rbac/user/add"  @click="$router.push('/student/querylist')">
                    <i class="el-icon-setting"></i>
                    <span slot="title">查询课表</span>
                </el-menu-item>
    ...
    export default {
        components: {selectCourseList,'r-header': RHeader},        
        methods: {
            logout() {
